...
export const FloatingDatePickerRenderer = ({ className, style, }) => {
    ...
    return (_jsxs("div", { ref: containerRef, className: clsx("crayon-date-picker-renderer-floating-container", className), style: style, children: [_jsx(FloatingDateInput, {}), _jsx(FloatingDatePicker, { ref: menuRef })] }));
};
