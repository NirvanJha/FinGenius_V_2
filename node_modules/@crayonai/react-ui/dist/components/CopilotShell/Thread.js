...
export const ScrollArea = ({ children, className, scrollVariant = "user-message-anchor", userMessageSelector = ".crayon-copilot-shell-thread-message-user", }) => {
    ...
    return (_jsxs("div", { className: "crayon-copilot-shell-thread-scroll-container", children: [_jsx("div", { ref: ref, className: clsx("crayon-copilot-shell-thread-scroll-area", {
                    "crayon-copilot-shell-thread-scroll-area--user-message-anchor": scrollVariant === "user-message-anchor",
                }, className), children: children }), isArtifactActive && (_jsx("div", { className: "crayon-copilot-shell-thread-artifact-panel--mobile", children: artifactRenderer() }))] }));
};
