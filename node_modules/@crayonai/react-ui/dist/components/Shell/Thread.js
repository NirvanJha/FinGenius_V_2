...
export const ThreadContainer = ({ children, className, isArtifactActive = false, renderArtifact = () => null, }) => {
    ...
    return (_jsx("div", { className: clsx("crayon-shell-thread-container", className, {
            "crayon-shell-thread-container--artifact-active": isArtifactActive,
        }), children: _jsxs("div", { className: "crayon-shell-thread-wrapper", ref: containerRef, children: [_jsx("div", { ref: chatPanelRef, className: clsx("crayon-shell-thread-chat-panel", {
                        "crayon-shell-thread-chat-panel--animating": !isDragging,
                    }), children: children }), !isMobile && isArtifactActive && (_jsxs(_Fragment, { children: [_jsx(ResizableSeparator, { onResize: handleResize, onDragStart: handleDragStart, onDragEnd: handleDragEnd }), _jsx("div", { ref: artifactPanelRef, className: clsx("crayon-shell-thread-artifact-panel", {
...
export const ScrollArea = ({ children, className, scrollVariant = "user-message-anchor", userMessageSelector, }) => {
    ...
    return (_jsxs("div", { className: "crayon-shell-thread-scroll-container", children: [_jsx("div", { ref: ref, className: clsx("crayon-shell-thread-scroll-area", {
                    "crayon-shell-thread-scroll-area--user-message-anchor": scrollVariant === "user-message-anchor",
                }, className), children: children }), isMobile && isArtifactActive && (_jsx("div", { className: "crayon-shell-thread-artifact-panel--mobile", children: artifactRenderer() }))] }));
};
