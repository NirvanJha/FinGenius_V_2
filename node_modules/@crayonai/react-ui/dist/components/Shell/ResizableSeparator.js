...
export const ResizableSeparator = ({ onResize, onDragStart, onDragEnd, className, }) => {
    ...
    return (_jsx("div", { className: clsx("crayon-shell-resizable-separator", className), onMouseDown: handleMouseDown, children: _jsx("div", { className: "crayon-shell-resizable-separator__handle" }) }));
};
