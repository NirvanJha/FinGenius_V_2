...
export declare const C1Chat: ({ processMessage, threadManager: userThreadManager, threadListManager: userThreadListManager, type, theme: userTheme, agentName, logoUrl, apiUrl, scrollVariant, formFactor: passedFormFactor, customizeC1, disableThemeProvider, generateShareLink, generateArtifactShareLink, onAction, }: {
    ...
    generateArtifactShareLink?: (artifactId: string, artifactType: string, message: Message, threadId: string) => Promise<string>;
    onAction?: OnAction;
}) => JSX_2.Element;
...
declare type C1ComponentInternalProps = {
    ...
    customComponents?: CustomComponentLibrary;
    __internal__wis__?: default_2.ComponentType<any>;
    artifactViewMode?: ArtifactViewMode;
    disableArtifactClose?: boolean;
    artifactActionComponent?: ArtifactActionComponent;
    __experimentalChartOptionsComponent?: ExperimentalChartOptionsComponent;
};
...
declare type C1ContextType = {
    ...
    disableArtifactClose: boolean;
    artifactActionComponent?: ArtifactActionComponent;
    WisdomVisualisationComponent?: React.ComponentType<any>;
    ExperimentalChartOptionsComponent?: ExperimentalChartOptionsComponent;
};
...
export declare type ExperimentalChartOptionsComponent = React.ComponentType<ExperimentalChartOptionsProps>;

export declare type ExperimentalChartOptionsProps = {
    getChartResponse: () => string;
};
